...
alias tr="cd && copytr && cd tr && rm -rf bash.bashrc && wget https://raw.githubusercontent.com/happyhere-TN/termux_xashDS-new-engine-/refs/heads/main/storage/emulated/0/download/termux-xash3D/tr/bash.bashrc && cp -rf bash.bashrc /data/data/com.termux/files/usr/etc"
